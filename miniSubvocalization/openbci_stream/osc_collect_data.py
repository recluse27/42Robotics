...
#             'yellow']
COLORS = ['red', 'green', 'yellow', 'light_blue', 'magenta', 'cyan']
...
def stream_window(*args):
    global g_iter, file_iter, label_iter, label_sample
    global CH_DATA

    label_sample = random.sample(range(0, 6), 6)
